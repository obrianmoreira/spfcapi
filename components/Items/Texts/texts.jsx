...
export const H4Text = (props) => {
    ...
    return (
        <>
            ...
            <h4 id={props.h4Style} className={Style.h4Style} value={props.value} onChange={props.onChange}>
                {props.h4Text}
            </h4>
...
export const Input = (props) => {
    ...
    return (
        ...
        <>
            <Frame frame={props.input}>
                <label htmlFor={props.htmlFor}>{props.label}</label>
                <input className={Style.inputStyle} type={props.type} placeholder={props.placeholder} id={props.id} value={props.value} onClick={props.onClick} onChange={props.chage} />
            </Frame>
        </>
